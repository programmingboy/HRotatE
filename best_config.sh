# Best Configuration for HRotatE
#
bash run.sh train HRotatE FB15k 0 0 256 128 1000 24.0 1.5 0.0001 150000 16 -de
bash run.sh train HRotatE FB15k-237 0 0 512 256 1000 10.0 1.5 0.0001 100000 16 -de
bash run.sh train HRotatE wn18 0 0 1024 32  500 12.0 0.5 0.001 80000 8 -de
bash run.sh train HRotatE wn18rr 0 0 1024 64 500 6.0 0.5 0.00005 80000 8 -de
bash run.sh train HRotatE YAGO3-10 0 0 1024 400 500 24.0 1.0 0.0002 100000 4 -de
#
